  ...
  <div class="login">
    ...
    <div class="middle-view">
      <div class="left-wrapper">
        ...
        <img src="@/assets/images/front02.png" alt=""/>
    ...
    <div class="el-login-footer">
      <span>{{
          systemInfo.copyRight || "Copyright © 2017-" + new Date().getFullYear() + " terra inc. All Rights Reserved."
        }}</span>
    </div>
  </div>
</template>
...
const systemInfo = {
  ...
  homeLogo: systemInfo1.homeLogo
      ? systemInfo1.homeLogo.includes("http")
          ...
          : "https://demo-ems.terracloud.com" + systemInfo1.homeLogo
      : "",
}
  ...
  loginRef.value.validate((valid) => {
    if (valid) {
      ...
      userStore
          ...
          .then(() => {
            const {redirect, ...restQueryParams} = route.query;
            router.push({path: redirect.value || "/", query: restQueryParams});
          })
          .catch(() => {
            loading.value = false
            // 重新获取验证码
